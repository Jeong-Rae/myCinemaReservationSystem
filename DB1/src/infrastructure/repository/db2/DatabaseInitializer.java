...
public class DatabaseInitializer {
    ...
    private void insertMovieExampleSet(Statement stmt) throws SQLException {
        executeUpdate("""
            ...
            (1, '기생충', '02:12:00', '15세이상관람가', '봉준호', '송강호', '드라마', '두 가정의 격차가 드러나는 사회 비판적 이야기', '2019-05-30 00:00:00', 8.6),
            (2, '베테랑', '02:04:00', '15세이상관람가', '류승완', '황정민', '액션', '불법행위를 하는 재벌 3세를 추적하는 형사의 이야기', '2015-08-05 00:00:00', 7.9),
            (3, '부산행', '01:58:00', '청소년관람불가', '연상호', '공유', '스릴러', '좀비 바이러스가 퍼지는 기차 안에서 벌어지는 생존기', '2016-07-20 00:00:00', 7.5),
            (4, '도둑들', '02:15:00', '15세이상관람가', '최동훈', '전지현', '범죄', '마카오 카지노에서 벌어지는 대규모 도둑질', '2012-07-25 00:00:00', 7.2),
            (5, '7번방의 선물', '02:07:00', '12세이상관람가', '이환경', '류승룡', '드라마', '정신지체를 가진 아버지와 그의 딸 이야기', '2013-01-23 00:00:00', 8.2),
            (6, '암살', '02:20:00', '15세이상관람가', '최동훈', '전지현', '역사', '일제강점기, 독립군의 일본 관료 암살 작전', '2015-07-22 00:00:00', 7.8),
            (7, '괴물', '01:59:00', '12세이상관람가', '봉준호', '송강호', '공포', '한강에 나타난 괴물과 한 가족의 싸움', '2006-07-27 00:00:00', 7.0),
            (8, '왕의 남자', '01:59:00', '12세이상관람가', '이준익', '감우성', '역사', '조선시대 광대들의 이야기', '2005-12-29 00:00:00', 7.5),
            (9, '내부자들', '02:10:00', '청소년관람불가', '우민호', '이병헌', '드라마', '정치와 비즈니스의 내부 비리를 파헤치는 이야기', '2015-11-19 00:00:00', 7.8),
            (10, '신과함께-죄와 벌', '02:20:00', '12세이상관람가', '김용화', '하정우', '판타지', '사후 세계에서 벌어지는 재판 과정을 그린 이야기', '2017-12-20 00:00:00', 7.3),
            (11, '택시운전사', '02:17:00', '15세이상관람가', '장훈', '송강호', '드라마', '1980년 광주 민주화 운동을 목격한 택시운전사 이야기', '2017-08-02 00:00:00', 8.9),
            (12, '아저씨', '02:00:00', '청소년관람불가', '이정범', '원빈', '액션', '납치된 이웃 소녀를 구하기 위한 남자의 사투', '2010-08-04 00:00:00', 7.8),
            (13, '국제시장', '02:06:00', '12세이상관람가', '윤제균', '황정민', '드라마', '한국 현대사를 배경으로 한 가족의 이야기', '2014-12-17 00:00:00', 6.8),
            (14, '최종병기 활', '02:02:00', '12세이상관람가', '김한민', '박해일', '역사', '조선시대, 왕을 구하기 위한 궁수의 활쏘기', '2011-08-10 00:00:00', 7.2),
            (15, '해운대', '02:00:00', '12세이상관람가', '윤제균', '설경구', '재난', '부산 해운대에 몰아치는 쓰나미를 중심으로 한 재난 영화', '2009-07-22 00:00:00', 6.7);
        """, stmt);
    }
    ...
    private void insertReservationExampleSet(Statement stmt) throws SQLException {
        executeUpdate("""
            INSERT INTO reservation (payment_method, payment_status, amount, payment_date, user_id) VALUES
